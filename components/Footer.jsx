...
const Footer = () => {
  return (
    // <div className={styles.container}>
        <div className="container-fluid p-3" style={{background: `url(${footerBg.src})`, position: "absolute", bottom: 0}}>
            <div className="row my-5" style={{padding: "2rem 7rem"}}>
                ...
                <div className="col-3">
                    ...
                    <ul className="list-group">
                        ...
                        <li className="list-unstyled text-white-50 my-3"><span className="p-1 text-white" style={{background: "purple", borderRadius: "50%", marginRight: "5px"}}><i class="fa fa-phone" aria-hidden="true" /></span><span className="text-white">Phone:</span> +2349 0145 44520.</li>
                        <li className="list-unstyled text-white-50"><span className="p-1 text-white" style={{background: "lightPink", borderRadius: "50%", marginRight: "5px"}}><i class="fa fa-envelope-o" aria-hidden="true" /></span><span className="text-white">Email:</span> info@elonatech.com</li>
                    </ul>
                </div>
                <div className="col-3">
            ...
            <div className="m-auto mt-5 d-flex justify-content-center">
                ...
                <span><small class="text-muted">Copyright (c) 2022 All rights reserved | Designed by Elonatech Nigeria Limited</small></span>
                </div>
            </div>
        </div>
  );
